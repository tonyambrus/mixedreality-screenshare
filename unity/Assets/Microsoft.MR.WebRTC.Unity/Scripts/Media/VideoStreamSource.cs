...
namespace WebRTC
{
    ...
    /// </summary>
    public abstract class VideoStreamSource : MonoBehaviour
    {
        /// <summary>
        ...
        /// </summary>
        public VideoStreamStartedEvent VideoStreamStarted { get; private set; } = new VideoStreamStartedEvent();
        ...
        /// </summary>
        public VideoStreamStoppedEvent VideoStreamStopped { get; private set; } = new VideoStreamStoppedEvent();
    }
}
