...
namespace WebRTC
{
    ...
    /// </summary>
    [AddComponentMenu("MixedReality-WebRTC/MRC Video Stream Source")]
    public class MrcVideoStreamSource : VideoStreamSource
    {
        /// <summary>
        ...
        /// </summary>
        public Microsoft.MixedReality.WebRTC.PeerConnection.VideoProfileKind VideoProfileKind = Microsoft.MixedReality.WebRTC.PeerConnection.VideoProfileKind.Unspecified;
        ...
        private async Task AddLocalVideoTrackImplAsync(Microsoft.MixedReality.WebRTC.PeerConnection nativePeer)
        {
                ...
                if (Windows.Graphics.Holographic.HolographicSpace.IsAvailable)
                {
                    if (!Windows.Graphics.Holographic.HolographicDisplay.GetDefault().IsOpaque)
                    {
                        if (Windows.ApplicationModel.Package.Current.Id.Architecture == Windows.System.ProcessorArchitecture.X86)
                        {
                            ...
                            videoProfileKind = Microsoft.MixedReality.WebRTC.PeerConnection.VideoProfileKind.VideoRecording; // No profile in VideoConferencing
                            width = 896; // Target 896 x 504
                        }
                        else
                        {
                            // Holographic AR (transparent) non-x86 platform - Assume HoloLens 2
                            videoProfileKind = Microsoft.MixedReality.WebRTC.PeerConnection.VideoProfileKind.VideoConferencing;
            ...
            var trackSettings = new Microsoft.MixedReality.WebRTC.PeerConnection.LocalVideoTrackSettings
            {
                trackName = trackName,
                videoDevice = default,
        ...
        private void I420ALocalVideoFrameReady(in I420AVideoFrame frame)
        {
