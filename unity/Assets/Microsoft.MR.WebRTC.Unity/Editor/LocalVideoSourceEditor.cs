...
namespace WebRTC.Editor
{
#if UNITY_EDITOR
    /// <summary>
    /// Inspector editor for <see cref="MrcVideoStreamSource"/>.
    ...
    /// is not available.
    /// </summary>
    [CustomEditor(typeof(MrcVideoStreamSource))]
    ...
    public class LocalVideoSourceEditor : UnityEditor.Editor
    {
        ...
        /// to the individual fields of the <see cref="MrcVideoStreamSource"/>.
        /// </summary>
        void OnEnable()
        {
        ...
        /// to draw the inspector GUI for the currently selected <see cref="MrcVideoStreamSource"/>.
        /// </summary>
        public override void OnInspectorGUI()
        {
            ...
            if ((LocalVideoSourceFormatMode)_mode.intValue == LocalVideoSourceFormatMode.Manual)
            {
                ...
                if ((_videoProfileKind.intValue != (int)Microsoft.MixedReality.WebRTC.PeerConnection.VideoProfileKind.Unspecified) && (_videoProfileId.stringValue.Length > 0))
                {
